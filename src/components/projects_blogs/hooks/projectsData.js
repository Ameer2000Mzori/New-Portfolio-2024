...
import FrontendcaseImg from "../../../assets/images/frontendcase.png";
import ShopsPrint from "../../../assets/images/shopsprint.png";
import TalentPortal from "../../../assets/images/talentportal.png";
import MonoText from "../../../assets/images/monotext.png";
import StepsMaster from "../../../assets/images/stepsmaster.png";

export const ProjectTitleData = [
  {
    title: "Crafting Digital Experiences That Matter",
  },
  {
    title: "Mohammed Ameen's Web Development Portfolio",
  },
];
...
export const projectsData = [
  ...
  },
  {
    ...
    type: "Full-Stack Development",
    description:
      "MonoText-MERN is a website built using the MERN stack, which incorporates React for the front end and Node.js, Express, and MongoDB for the back end. It also utilizes ESLint to ensure cleaner code, Prettier for code formatting, and Tailwind CSS for styling. Please download the project to experience a live demo.",
    technologies: [
      "react.js",
      "javascript",
      "node.js",
